# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-07 15:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='avatar/default.png', max_length=200, null=True, upload_to='avatar/%Y/%m', verbose_name='用户图形')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callback_url', models.URLField(blank=True, null=True, verbose_name='回滚url')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Comment', verbose_name='父级评论')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Category', verbose_name='文章分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
